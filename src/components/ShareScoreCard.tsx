...
export function ShareScoreCard(props: ShareScoreProps) {
  ...
  const shareText = `🔥 SchoolTribe Score Update!
...
#SchoolTribe #EduNext #CBSE #Class10`;
          ...
          <div className="glass-card">
            ...
            <div className="bg-gradient-to-br from-surface-700 to-surface-900 rounded-xl p-6 mb-6 border border-surface-600">
              ...
              <div className="flex items-center justify-center gap-2 mb-4">
                <span className="text-2xl font-bold text-gradient">SchoolTribe</span>
                <span className="text-slate-600 text-sm">x</span>
                <span className="text-sm text-slate-400 font-medium">VSPS</span>
              </div>
