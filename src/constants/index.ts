...
export const APP_NAME = 'SchoolTribe';
export const APP_DESCRIPTION = 'Board Exam Prep — CBSE & ICSE, Class 8 to 10';
export const APP_TAGLINE = 'A unit of EduNext';
export const SCHOOL_PARTNER = 'Dr. Virendra Swarup Public School, Cantt. Kanpur';
export const SCHOOL_PARTNER_SHORT = 'VSPS Cantt Kanpur';
export const SCHOOL_LOGO_URL = 'https://www.vspscantt.in/images/logo1.png';
